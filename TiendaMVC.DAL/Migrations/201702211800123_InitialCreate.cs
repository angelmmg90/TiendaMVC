namespace TiendaMVC.DAL.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ShoppingCarts", "Client_Id", "dbo.AspNetUsers");
            ...
            DropForeignKey("dbo.Documents", "Product_Id1", "dbo.Products");
            ...
            DropIndex("dbo.Documents", new[] { "Product_Id1" });
            DropTable("dbo.Taxes");
